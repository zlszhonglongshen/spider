...
def init_spider(keyword):
    ...
    driver = webdriver.Chrome(executable_path='C:/Program Files (x86)/Google/Chrome/Application/chromedriver.exe')
    driver.get(url)
    cookieList = ['HMACCOUNT=C47411FC0EB9C62D; BAIDUID=9F66D39EDE134F85E63D06EEDA618684:FG=1; BDUSS=0tGZkNYVy1aREZWdWxlNUJLcTR4RTRFb053OEhvQXBlNU5Yc00wM0xhcFZmM0pjQVFBQUFBJCQAAAAAAAAAAAEAAAAZzAAp0MTA5DIwODAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFXySlxV8kpcM']
