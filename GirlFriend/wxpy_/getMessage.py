...
def get_data(city_name):
    ...
    return now,days[weekday],weather
    # ,temperatureLow,temperatureHigh,winL,getPM25()
...
count = 0
try:
    now,weekday,weather = get_data("广州".split(' '))
    message = now+ "\n" + weekday + "\n" + weather + "\n"
    print(message)
except:  # 抛出异常
    message = ""
